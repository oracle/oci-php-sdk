...
class UploadManager
{
    ...
    /**
     * Construct method for UploadManager
     * @param ObjectStorageAsyncClient $objectStorageClient async object storage client
     * @param array $config config the UploadManager, see UploadManagerConstants for configurable params
     */
